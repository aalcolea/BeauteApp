              ...
              child: Column(
                children: [
                              ...
                              Column(
                                ...
                                children: [
                                  Text(SessionManager.instance.Nombre == 'Dulce' ? 'Nombre Asistente' : SessionManager.instance.Nombre,
                                      style: TextStyle(fontWeight: FontWeight.bold, fontSize: MediaQuery.of(context).size.width*0.05, color: AppColors2.primaryColor)),
                  ...
                  InkWell(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        border: widget.currentScreen == 'agenda' ? Border.all(color: AppColors2.primaryColor) : const Border(left: BorderSide.none, top: BorderSide(color: Color(0XFF4F2263))),
                        color: widget.currentScreen == 'agenda' ? AppColors2.primaryColor : Colors.transparent,
                  ...
                  InkWell(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        color: widget.currentScreen == 'agenda' ? Colors.transparent : AppColors2.primaryColor,
                  ...
                  Visibility(
                    ...
                    child: InkWell(
                        splashColor: AppColors2.primaryColor.withOpacity(0.1),
                        onTap: (){
                          setState(() {
                                          ...
                                          children: [
                                            Text(
                                              ...
                                              style: TextStyle(
                                                  ...
                                                  color: AppColors2.primaryColor.withOpacity(0.4)
                                              ),
                                            ),
                                          ],
                                        ),)
                    ...
                    child: Container(
                      ...
                      child: ElevatedButton(
                          ...
                          style: ElevatedButton.styleFrom(
                            backgroundColor: Colors.white,
                            side: const BorderSide(color: AppColors2.primaryColor, width: 1.0),
                          ...
                          children: [
                            TextButton(
                                ...
                                child: Row(
                                  mainAxisAlignment: MainAxisAlignment.center,
                                  children: [
                                    const Icon(Icons.exit_to_app, color: AppColors2.primaryColor),
                                    SizedBox(width: 10),
                                    Text('Cerrar sesion', style: TextStyle(fontSize: MediaQuery.of(context).size.width*0.05, color: AppColors2.primaryColor))
                                        ]))
                              ])))
                ])),
          );
